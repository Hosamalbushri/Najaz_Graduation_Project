        ...
        <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                                        ...
                                        >
                                            <template #item="{ element: field, index: fieldIndex }">
                                                <div class="mb-2.5 rounded border border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900">
                                                    ...
                                                    <!-- Display options as separate items under the field (read-only) -->
                                                    <div 
            ...
            <x-admin::modal ref="addEditFieldModal">
                ...
                <x-slot:footer>
                    ...
                    >
                        @{{ selectedFieldIndex === null ? '@lang("Admin::app.services.attribute-groups.edit.save-field-btn")' : '@lang("Admin::app.services.attribute-groups.edit.update-field-btn")' }}
                    </button>
                </x-slot:footer>
            </x-admin::modal>
        ...
        app.component('v-service-attribute-groups', {
            ...
            data() {
                return {
                    ...
                    fieldOrderOriginal: {}, // Store original field order for each group
            ...
            watch: {
                'selectedField.service_attribute_type_id'(newVal, oldVal) {
                    ...
                    if (newVal && this.selectedField && this.selectedField.id) {
                        this.loadFieldOptions(this.selectedField.id);
                    } else if (!newVal) {
            ...
            methods: {
                ...
                async removeGroup(index) {
                    ...
                    if (! confirm("@lang('Admin::app.services.services.attribute-groups.confirm-delete')")) {
                        return;
                    }
                ...
                loadFieldOptions(fieldId) {
                    ...
                    // Find field in selected groups
                    const group = this.selectedGroups[this.selectedFieldGroupIndex];
                    if (!group || !group.fields) {
                        this.selectedFieldOptions = [];
                        return;
                    }
                    ...
                    if (field && field.options) {
                        this.selectedFieldOptions = Array.isArray(field.options) ? field.options.map(opt => ({
                            ...opt,
