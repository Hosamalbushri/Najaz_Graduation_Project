            ...
            >
                ...
                >
                    <div class="flex min-h-full items-end justify-center p-5 sm:items-center sm:p-0">
                        <div class="box-shadow absolute left-1/2 top-1/2 z-[999] w-full max-w-[400px] -translate-x-1/2 -translate-y-1/2 rounded-lg bg-surface-card dark:bg-surface-card max-md:w-[90%]">
                            <div class="flex items-center justify-between gap-2.5 border-b px-4 py-3 text-lg font-bold text-text-primary dark:border-border-default dark:text-text-inverse">
                                @{{ title }}
                            </div>

                            <div class="px-4 py-3 text-right text-text-secondary dark:text-text-secondary">
                                @{{ message }}
                            </div>
