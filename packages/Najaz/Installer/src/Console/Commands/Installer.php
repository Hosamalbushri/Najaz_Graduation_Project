...
class Installer extends Command
{
     ...
     * @var string
     */
    protected $signature = 'najaz:install
     ...
     * @var string
     */
    protected $description = 'Najaz installer.';
    ...
    public function handle(): void
    {
        ...
        $this->warn('Step: Seeding basic data for Najaz kickstart...');
    ...
    protected function askForApplicationDetails(): void
    {
        $this->updateTextTypeEnv(
            ...
            $this->getEnvVariable('APP_NAME', 'Najaz')
        );
    ...
    protected function askForAdminDetails()
    {
        ...
        try {
            ...
            File::put($filePath, 'Najaz is successfully installed.');

            $this->info('-----------------------------');
            $this->info('Congratulations!');
            $this->info('The installation has been finished and you can now use Najaz.');
            $this->info('Go to '.$this->getEnvVariable('APP_URL').' and authenticate with:');
            $this->info('Email: '.$adminEmail);
            $this->info('Password: '.$adminPassword);
            $this->info('Cheers!');

            Event::dispatch('najaz.installed');
        } catch (\Exception $e) {
    ...
    protected function askForGithubStar(): void
    {
        ...
        $repoUrl = 'https://github.com/najaz/najaz';
