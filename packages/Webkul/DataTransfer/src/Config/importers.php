...
//    ],
    ...
    'services' => [
        ...
        'sample_paths' => [
            'csv'  => 'data-transfer/samples/csv/services.csv',
            'xls'  => 'data-transfer/samples/xls/services.xls',
            'xlsx' => 'data-transfer/samples/xlsx/services.xlsx',
            'xml'  => 'data-transfer/samples/xml/services.xml',
        ],
    ],
    ...
    'citizens' => [
        ...
        'sample_paths' => [
            'csv'  => 'data-transfer/samples/csv/citizens.csv',
            'xls'  => 'data-transfer/samples/xls/citizens.xls',
            'xlsx' => 'data-transfer/samples/xlsx/citizens.xlsx',
            'xml'  => 'data-transfer/samples/xml/citizens.xml',
        ],
    ],
];
